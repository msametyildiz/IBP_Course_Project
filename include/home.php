...
<div>
    <div style="height:600px; background-image: url('<?= SITE ?>img/banner/mainpic.jpg');background-size: cover;background-attachment: fixed;	background-position:center; background-color:gray;opacity: 0.5;">
                ...
                <div class="tab-content" id="nav-tabContent" style="padding-top:4%;padding-bottom:6%">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            ...
                            ?>
                                    <div class="col-xl-4 col-lg-4 col-md-6" onclick="location.href='<?= SITE ?>kitap-detay/<?= $kitaplar[$i]['selflink'] ?>';">
                                        <div class="single_explorer">
                                            <div class="thumb">
